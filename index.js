...
const UUID = process.env.UUID || 'a217d527-bd5e-4ef0-b899-d36627af0ddd'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'qazwsxedc123';            // 获取节点的订阅路径
